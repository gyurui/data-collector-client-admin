...
const Products: React.FC = () => {
    ...
    function onProductSelect(product: Product): void {
    ...
    return (
        <Fragment>
            ...
            <div className="row">
                ...
                {products.modificationState === ProductModificationStatus.Create || (products.modificationState === ProductModificationStatus.Edit && products.selectedProduct) ? (
                    <ProductForm />
                ) : null}
            </div>
